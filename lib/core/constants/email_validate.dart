...
abstract class EmailValidate {
  static const List<String> emailDomains = [
    ...
    "besure2vote.com",
    "bigtimecatperson.com",
    "bigtimedogperson.com",
    "bigtimereader.com",
    "bigtimesportsfan.com",
    "blackvoices.com",
    "capsfanatic.com",
    "capshockeyfan.com",
    "capsred.com",
  ...
  static const List<String> emailDomainsTest = [
    'gmail.*',
    'lycos.co*.*',
    'mail2*.com',
    '*.onmicrosoft.com',
  ...
  RegExp regex1 = RegExp(r'^gmail\.[a-zA-Z0-9]+(?:\.[a-zA-Z]{2,})?$'); //gmail.*
  RegExp regex2 = RegExp(r'^lycos\.co.*$'); //lycos.co*.*

  RegExp regex3 = RegExp(r'^mail2.*\.com$'); //mail2*.com
  RegExp regex4 = RegExp(r'^.*\.onmicrosoft\.com$'); //*.onmicrosoft.com

  static bool isFreeEmail(String email) {
    for (String d in emailDomains) {
      if (_checkEmail(email, d)) {
        return true;
      }
    }
    return false;
  ...
  static bool _checkEmail(String email, String domain) {
    ...
    try {
      ...
      if (domain.startsWith('*.')) {
        ...
        if (indexOfFirstDot != -1) {
          String firstPart = domain.substring(0, indexOfFirstDot);
          String secondPart = domain.substring(indexOfFirstDot + 1);
          RegExp regex = RegExp('^.*\\.$firstPart\\.$secondPart\$');
          if (regex.hasMatch(emailDomain)) {
            return true;
          }
        }
        ...
        // gmail.*
        domain = domain.substring(0, domain.length - 3);
        RegExp regex = RegExp('^$domain\\.[a-zA-Z0-9]+(?:\\.[a-zA-Z]{2,})?\$');
        if (regex.hasMatch(emailDomain)) {
          return true;
        }
        ...
        RegExp regex = RegExp('^${parts[0]}.*\\.${parts[1]}\$');
        if (regex.hasMatch(emailDomain)) {
          return true;
        }
      } else {
